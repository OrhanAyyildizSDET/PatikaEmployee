...
//1. way ı used 2 arrays for add the second array from 1. array
        ...
        System.out.println(reverseWord.equals(str)?"Patika1_2Week.Polindrome": "is not palindrome");
...
//2. way ı used for loops and started the end of the array
        ...
        System.out.println(Arrays.equals(words, phrase) ?"Patika1_2Week.Polindrome": "is not palindrome");
...
//    3. way with recursive method
        ...
        System.out.println(finalNumber == number?"Patika1_2Week.Polindrome":"is not palindrome");
