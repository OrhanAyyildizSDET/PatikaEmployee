...
public class Employee {
    ...
    public static void employeeDetail(String name, int salary, int workHours, int hireYear){
        System.out.println("Patika1_2Week.Employee Name is : "+name);
        System.out.println("Patika1_2Week.Employee Salary is : "+salary);
        System.out.println("Patika1_2Week.Employee WorkHours is : "+workHours);
        System.out.println("Patika1_2Week.Employee HireYear is : "+hireYear);
    }
